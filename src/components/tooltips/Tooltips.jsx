...
export default function Tooltips({ pentaPrompts }) {
  ...
  return (
    <div className="relative inline-block cursor-pointer">
      ...
      {isOpen && (
        <div className="absolute left-0 bottom-8 z-10 w-64  p-4 bg-gradient-to-br from-blue-200 to-blue-500 border-1 shadow-xl rounded-xl text-white backdrop-blur-sm font-bold bg-opacity-90 transform transition-all ease-in-out">
